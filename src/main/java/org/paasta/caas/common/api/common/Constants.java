...
public class Constants {
    ...
    public static final String URI_API_USERS_BY_SUID_AND_SPACE_GUID = "/users/serviceInstanceId/{serviceInstanceId:.+}/spaceGuid/{spaceGuid:.+}";
    public static final String URI_API_USERS_BY_SUID_AND_SPACE_GUID_AND_USER_ID = "/users/serviceInstanceId/{serviceInstanceId:.+}/spaceGuid/{spaceGuid:.+}/userId/{userId:.+}/";
