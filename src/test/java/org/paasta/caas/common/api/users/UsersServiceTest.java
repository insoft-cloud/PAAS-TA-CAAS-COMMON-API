...
public class UsersServiceTest {
    ...
    public void getUsersByServiceInstanceIdAndOrganizationGuid_Valid_ReturnModel(){
        // CONDITION
        when(userRepository.findByServiceInstanceIdAndSpaceGuid(SERVICE_INSTANCE_ID, ORGANIZATION_GUID)).thenReturn(gTestResultList);

        // TEST
        UsersList resultList = userService.getUsersByServiceInstanceIdAndSpaceGuid(SERVICE_INSTANCE_ID, ORGANIZATION_GUID);
    ...
    public void getUserByServiceInstanceIdAndOrganizationGuid_Valid_ReturnModel(){
        // CONDITION
        when(userRepository.findByServiceInstanceIdAndSpaceGuidAndUserId(SERVICE_INSTANCE_ID, ORGANIZATION_GUID, USER_ID)).thenReturn(gTestResultModel);
        when(commonService.setResultModel(gTestResultModel, Constants.RESULT_STATUS_SUCCESS)).thenReturn(gTestFinalModel);

        // TEST
        Users resultModel = userService.getUserByServiceInstanceIdAndSpaceGuid(SERVICE_INSTANCE_ID, ORGANIZATION_GUID, USER_ID);
    ...
    public void updateUserRoleByServiceInstanceIdAndOrganizationGuid_Valid_Return_Model(){
        ...
        // TEST
        Users resultModel = userService.updateUserRoleByServiceInstanceIdAndSpaceGuid(gTestModel);
    ...
    public void deleteUser_Valid_ReturnModel() {
        ...
        // CONDITION
        when(userRepository.deleteByServiceInstanceIdAndSpaceGuidAndUserId(gTestModel.getServiceInstanceId(), gTestModel.getOrganizationGuid(), gTestModel.getUserId())).thenReturn(1);
        when(commonService.setResultModel(gTestEmptyModel, Constants.RESULT_STATUS_SUCCESS)).thenReturn(gTestResultModel);

        // TEST
        Users resultModel = userService.deleteByServiceInstanceIdAndSpaceGuid(gTestModel.getServiceInstanceId(), gTestModel.getOrganizationGuid(), gTestModel.getUserId());
    ...
    public void deleteUser_Invalid_ReturnModel(){
        ...
        // CONDITION
        when(userRepository.deleteByServiceInstanceIdAndSpaceGuidAndUserId(gTestModel.getServiceInstanceId(), gTestModel.getOrganizationGuid(), gTestModel.getUserId())).thenReturn(0);
